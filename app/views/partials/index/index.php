        ...
        ?>
        <div  class=" py-5" class="py-5" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('assets/images/bguninuskampus.png'); background-size: cover; background-position: center;">
            <div class="container">
                <div class="row ">
                        ...
                        <div class="">
                          <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                  <h2 align="center" class="text-capitalize" style="color: white;">ARSIP SURAT<br> Universitas Islam Nusantara </h2>
                                    
                                    <div class=""><div><center><img src="assets/images/lguninus.png" width="150" height="160" /></center></div>
                    ...
                    <div class="col-md-4 comp-grid">
                        ...
                        <div class="login-container bg-light p-3 animated fadeIn page-content">
                            <div>
